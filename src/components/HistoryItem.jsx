export default function HistoryItem() {
  return (
    <div className="w-[90%] h-[80px] mb-3 transition-all  hover:shadow border-[#fff] py-3 px-2 hover:scale-105 mx-auto rounded flex hover:border-red-500 border cursor-pointer items-center ">
      ...
      <span className="flex flex-col  mr-10 " style={{ width: "calc(100% - 250px)" }}>
