...
import TicketsAssigmentForm from "../pages/TicketsAssigmentForm";
...
export default function TicketsTable({
  ...
  return (
    <>
              ...
              .map((ticket) => (
                <tr key={ticket.id} className="hover:bg-gray-100 transition">
                  ...
                  {/* <td className=" font-medium">
                    <select className="p-2 border rounded-md border-gray-500 " value={ticket.priority}>
                  ...
                  <td className="py-4 px-5 text-[14px]">{ticket.startDate}</td>
      ...
      {isOpen ? <TicketsAssigmentForm setIsOpen={setIsOpen} /> : null}
    </>
  );
}
